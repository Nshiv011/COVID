...
Plasma Donation</h1>
                    <p>Your contribution may help save a life!</p>
                </div>
            </div>
        </div>
...
<li>You have fully recovered and are free of symptoms<br/>
for 14 days</li>
...
<li>You have chronic kidney/heart/lung or liver disease.</li>
  ...
  <Form.Group controlId="formBasicPassword">
     ...
     <Form.Group controlId="formBasicPassword">
                        <Form.Label  className="lab">What was your date of Recovery</Form.Label>
                        <Form.Control  className="lab1" type="date" />
                    </Form.Group>
  ...
  <fieldset>
  <Form.Group as={Row}>
                    <Form.Label  className="lab">Any discharge report from hospital</Form.Label>
                    </Form.Group>         
    <Form.Group as={Row}>
      <Form.Label as="legend" column sm={2}>
      </Form.Label>
  ...
  <fieldset>
  <Form.Group as={Row}>
                    <Form.Label  className="lab">Test COVID negative in last 2 weeks</Form.Label>
                    </Form.Group>         
    <Form.Group as={Row}>
      <Form.Label as="legend" column sm={2}>
      </Form.Label>
